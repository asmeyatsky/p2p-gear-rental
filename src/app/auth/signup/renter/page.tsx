...
export default function SignupRenterPage() {
        ...
        <div className="py-8">
          <div className="max-w-md mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900">Create a Renter Account</h2>
              <p className="mt-2 text-gray-600">
                Get started with your free account to rent gear.
              </p>
            </div>
